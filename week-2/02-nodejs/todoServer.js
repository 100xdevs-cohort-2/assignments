...
app.put("/todos/:id", (req, res) => {
  const existingTodo = TODOS.findIndex((todo) => todo.id == req.params.id);
  if (existingTodo === -1) return res.status(404).send("Todo not found");
  ...
  TODOS.splice(existingTodo, 1, updatedTodo);
